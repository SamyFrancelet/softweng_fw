...
#define MQTT_EXTRA_LOGS       (0)  /* set to 1 to produce extra log output */
  ...
  #define TOPIC_NAME_SENSOR_TEMPERATURE     "softw_eng/roof/temperature"
  #define TOPIC_NAME_SENSOR_HUMIDITY        "softw_eng/roof/humidity"
#endif
...
#define MQTT_DEFAULT_BROKER   "broker.emqx.io"
#define MQTT_DEFAULT_CLIENT   "client"
#define MQTT_DEFAULT_USER     "emqx"
#define MQTT_DEFAULT_PASS     "public"
